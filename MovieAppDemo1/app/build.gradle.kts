...
android {
    namespace = "com.example.movieappdemo1"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.movieappdemo1"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        buildConfigField("String", "BASE_MOVIE_POSTER", "${project.properties["BASE_MOVIE_POSTER"]}")
    }
