...
sealed interface LibraryMapViewModelEvent {
    ...
    data class SelectMarker(val libCode: Int?): LibraryMapViewModelEvent
    ...
    data class RequestLibraryBookData(val libCode: Int, val isbn13: String, val type: String) : LibraryMapViewModelEvent
}
...
sealed interface LibraryMapUiEvent {
    ...
    data class UpdateSelectedLibCode(val libCode: Int?): LibraryMapUiEvent
